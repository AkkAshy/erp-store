...
class TransactionHistoryPagination(OptionalPagination):
    """
    Специализированная пагинация для истории транзакций
    """
    default_limit = 50  # Больше записей для истории транзакций
    max_limit = 200     # Увеличенный лимит для отчетов
